...
I'll use the same notation as https://www.khronos.org/registry/glTF/specs/2.0/glTF-2.0.html#implementation, plus some more:
...
Ignoring fog and texture for now, the fragment shader implements the following computation of the color at at particular location: 
\[
...
[sample implementation](https://www.khronos.org/registry/glTF/specs/2.0/glTF-2.0.html#implementation), with several comments
